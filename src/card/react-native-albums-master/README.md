# React Native App: Albums

Code following along from the Udemy course [the Complete React Native and Redux Course](https://www.udemy.com/the-complete-react-native-and-redux-course/learn/v4/content).

## Setup

This project uses eslint and the "rallycoding" config.

Linter set-up in Atom:

- linter
- linter-eslint

Install the "rallycoding" config in the command line.
...
And add the below to the newly created `.eslintrc` file:
